...
CloudSubscriber::CloudSubscriber(const ros::NodeHandle& nh, const std::string& topic_name, size_t buff_size) : nh_(nh) {
...
void CloudSubscriber::msg_callback(const sensor_msgs::PointCloud2::ConstPtr& cloud_msg_ptr) {
  ...
  pcl::fromROSMsg(*cloud_msg_ptr, *(cloud_data.ptr));
